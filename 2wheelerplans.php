...
// Code Start for scooterwash  wash 1
                    ...
                    <div class="col-md-6">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                <h3>Scooter Wash</h3>
                                <h2>₹<strong><?php echo $row['scooterwash'];?></strong></h2>
                            </div>
                        ...
                        <div class="price-item featured-item ">
                            <div class="price-header">
                                <h3>Bike Wash</h3>
                                <h2>₹<strong><?php echo $row['bikewash'];?></strong></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                <li><i class="far fa-check-circle"></i>Exterior Cleaning</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="scooterwash">Scooter Wash  <?php echo '₹'.$row['scooterwash'];?></option>
...
<?php } ?>
            ...
            <p><input type="text" name="fname" class="form-control"pattern="[a-zA-Z ]{3,20}" title="No numbers and special characters allowed" required placeholder="Enter Full Name" value="<?php echo $_SESSION['uname'];?>" readonly></p>
            <p><input type="text" name="contactno" class="form-control" pattern="[0-9]{10}" title="10 numeric characters only" required placeholder="Enter Mobile No." value="<?php echo $_SESSION['phoneno'];?>" readonly></p>
...
elseif ($currentTime >= '16:00' && $currentTime < '17:00') 
{
    ...
    // evening options
    echo '<option value="11">Booking Closed</option>';
...
?>
             ...
             <p>Address<textarea name="address" required class="form-control" placeholder="Enter your address" maxlength="200" readonly><?php echo $_SESSION['saddr'];?></textarea></p>
...
<!--  payment choice end-->
            ...
            <center> <p><input type="submit" class="btn btn-custom" id='disabletest' name="book4" value="Book Now">
  ...
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <!-- <option value="1">BODY WASH (₹400)</option> -->
                 <option value="bikewash">Bike Wash <?php echo '₹'.$row['bikewash'];?></option>
                  <!-- <option value="3 ">PREMIUM WASH (₹600)</option> -->
              </select>
...
<?php } ?>
            ...
            <p><input type="text" name="fname" class="form-control"pattern="[a-zA-Z ]{3,20}" title="No numbers and special characters allowed" required placeholder="Enter Full Name" value="<?php echo $_SESSION['uname'];?>" readonly></p>
            <p><input type="text" name="contactno" class="form-control" pattern="[0-9]{10}" title="10 numeric characters only" required placeholder="Enter Mobile No." value="<?php echo $_SESSION['phoneno'];?>" readonly></p>
            <p>Vehicle Number <br /><input type="text" name="regno" required class="form-control" pattern="[a-zA-Z0-9]{3,10}" title="Enter valid vehicle number" value="<?php echo $_SESSION['vno'];?>" readonly></p>
...
?>
            ...
            <p>Wash Date <br /><input type="date" name="washdate" required  class="form-control"  min="<?php echo $min_date; ?>"></p>
...
<!--  payment choice end-->
            ...
            <center> <p><input type="submit" class="btn btn-custom"  id="disabletest2" name="book5" value="Book Now"  >
             <input type="reset" class="btn btn-custom" name="reset" value="Reset"></p><center>
      </form>
        </div>
        <div class="modal-footer">
...
<script>
  ...
  if (currentTime < startTime || currentTime > endTime) {
    document.getElementById("disabletest").disabled = false;
...
<!-- In this example, the button with the ID "myButton" is disabled if the current time is earlier than 9:00 AM or later than 5:00 PM. You can adjust the time range by modifying the startTime and endTime variables to your desired time range. -->