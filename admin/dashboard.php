...
<!-- 2nd row -->
				...
				<a href="http://localhost/cwms/admin/manageusers.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							<div class="icon">
							<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
...
<?php $sql2 = "SELECT uid from testsign";
$query2= $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$cnt2=$query2->rowCount();
...
<!--  -->
					...
					<a href="http://localhost/shopping/admin/manage-products.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-wthree">
							<div class="icon">
							<i class="glyphicon glyphicon-list-alt" aria-hidden="true"></i>
...
<div class="four-grids">
			<a href="http://localhost/cwms/admin/updateprice.php" target="_blank">
					<div class="col-md-3 four-grid">
						<div class="four-w3ls">
							<div class="icon">
								<i class="glyphicon glyphicon-folder-open" aria-hidden="true"></i>
							...
							<div class="four-text">
								<h3>Update Prices</h3>
												<?php $sql5 = "SELECT * from prices";
$query5= $dbh -> prepare($sql5);
$query5->execute();
$results5=$query5->fetchAll(PDO::FETCH_OBJ);
$washingpoints=$query5->columnCount();
					?>
								<h4><?php echo htmlentities($washingpoints-1);?></h4>
