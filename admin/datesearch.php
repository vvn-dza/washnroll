  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Enter booking date </label>
									<div class="col-sm-8">
										<input type="date" name="bdate" class="form-control" required placeholder="Enter the booking date">
									</div>
								</div>

                            <?php $bdate=$_POST['bdate'];?>
