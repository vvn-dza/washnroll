...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Search by date</li>
            </ol>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Enter Start Date </label>
									<div class="col-sm-8">
										<input type="date" name="sdate" class="form-control" required placeholder="Enter the booking date">
									</div>
								</div>
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Enter Ending Date </label>
									<div class="col-sm-8">
										<input type="date" name="edate" class="form-control" required placeholder="Enter the booking date">
									</div>
								</div>

                            <?php $sdate=$_POST['sdate'];?>
                            <?php $edate=$_POST['edate'];?>
					  ...
					  <h2>Search by date</h2>
						...
						<thead>
						  ...
						  <th>Booking No.</th>
							...
							<th width="200">Posting dates </th>
							<th>Action </th>
							
						  </tr>
						</thead>
						<tbody>
<?php $sql = "SELECT *,tblcarwashbooking.id as bid from tblcarwashbooking WHERE washDate BETWEEN '$sdate' AND '$edate' AND status='completed'";
