...
header('location:index.php');
	...
	{
	$delid=$_POST['delid'];
    $sql="DELETE from tblcarwashbooking where bookingId=:delid";
    $query = $dbh->prepare($sql);
    $query->bindParam(':delid',$delid,PDO::PARAM_STR);
    $query->execute();
    
     echo "<script>alert('Booking deleted successfully');</script>";
     echo "<script>window.location.href ='deletebooking.php'</script>";
    }
...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Delete booking </li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Booking ID to delete</label>
									<div class="col-sm-8">
										<input type="text" name="delid" class="form-control"  pattern="[0-9]{9}" title="Enter a valid booking id"required placeholder="Enter the Booking ID ">
									</div>
								</div>
