...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Edit Location</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
...
<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea class="form-control" name="address" id="address" placeholder="Technician name" required rows="4"><?php echo htmlentities($result->washingPointAddress);?></textarea>
									</div>
								</div>
