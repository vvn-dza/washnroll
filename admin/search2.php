...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Search Bookings</li>
            </ol>
  	         ...
  	         <div class="tab-content">
						<div class="tab-pane active" id="horizontal-form">
							<form class="form-horizontal" name="washingpoint" method="post" enctype="multipart/form-data">
								...
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Enter booking id </label>
									<div class="col-sm-8">
										<input type="text" name="booking_id" pattern="[0-9]{9}" title="Enter 9 digit booking id only"class="form-control" required placeholder="Enter the booking id">
									</div>
								</div>
...
if($ptype=="bodywash"): echo "BODY WASH ";endif;
if($ptype=="fullwash"): echo "FULL WASH ";endif;
if($ptype=="premiumwash"): echo "PREMIUM WASH ";endif;
if($ptype=="scooterwash"): echo "SCOOTER WASH ";endif;
if($ptype=="bikewash"): echo "BIKE WASH";endif;


							?></td>
							
						
							<td><?php echo htmlentities($result->price	);?><br />
