...
$sql="update  tblsubbooking set adminRemark=:message,paymentMode=:ttype,txnNumber=:transactionno,status='Completed' where id=:id";
...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage New Subscriptions</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Subscription Details #<?php echo $_GET['bookingid'];?></h2>
					    <table id="table">
...
<?php 
$bid=$_GET['bid'];
$sql = "SELECT * from tblsubbooking
join tblwashingpoints on tblwashingpoints.id=tblsubbooking.carWashPoint
 where tblsubbooking.id='$bid'";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>		
						  <tr>
						  	<th width="200">Suscription Id#</th>
...
if($ptype==1): echo "monthly";endif;
if($ptype==2): echo "3 monthly";endif;
if($ptype==3): echo "6 monthly";endif;
