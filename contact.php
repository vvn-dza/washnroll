...
<html lang="en">
    <head>
        ...
        <link href="bluecss/style.css" rel="stylesheet">
          <!-- <link href="washinghubcss/style.css" rel="stylesheet"> -->
    </head>
...
?>
  ...
  <div class="contact-info-item">
                ...
                <?php } ?>
                    ...
                    <!-- <h1>Our location     </h1> -->
                    <br><br>
           <div class="mapouter"><div class="gmap_canvas"><iframe width="920" height="600" id="gmap_canvas" src="https://maps.google.com/maps?q=overdrive mangalore&t=&z=14&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://2yu.co">2yu</a><br><style>.mapouter{position:relative;text-align:right;height:510px;width:817px;}</style><a href="https://embedgooglemap.2yu.co"></a><style>.gmap_canvas {overflow:hidden;background:none!important;height:510px;width:1017px;}</style></div></div>
