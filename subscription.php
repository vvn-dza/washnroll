...
$sql="INSERT INTO tblsubbooking(bookingId,packageType,carWashPoint,fullName,mobileNumber,washDate,washTime,message,status) VALUES(:bno,:ptype,:wpoint,:fname,:mobile,:date,:time,:message,:status)";
...
echo '<script>alert("Your booking subscription done successfully. Booking number is "+"'.$bno.'")</script>';
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Auto Cleanse | Subscription Plans</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                <h3>6 months</h3>
                                <h2><span></span><strong>₹2500</strong></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>$</span><strong>₹700</strong></h2>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
